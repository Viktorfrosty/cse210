...
- added a handler in case that there is not any goal listed and the record event, the save goals or erase goals options are selected.
- Added .TryParse to handle parse invalid transformations.
*/
